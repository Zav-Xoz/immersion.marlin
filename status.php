                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control"  type="text" name="select" id="example-select">
                                            <?php foreach($arrStatus as $key => $value):?>
                                                <?php if($key == $edit_user_arr['status']): ?>
                                                 <option selected="selected" value="<?php echo $key;?>"><?php echo $arrStatus[$key]?></option>
                                                  <?php else: ?>
                                                            <option  value="<?php echo $key;?>"><?php echo $arrStatus[$key]?></option>
                                                  <?php endif;?>
                                            <?php endforeach?>
                                        </select>
                                    </div>
