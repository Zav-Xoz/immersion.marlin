...
$myId = this_is_my_id($user_session);
            ...
            <div class="col-xl-4">
                <div id="c_<?php echo $value['id'] ?>" class="card border shadow-0 mb-g shadow-sm-hover"
                    ...
                    <div class="card-body p-0 collapse show">
                        <div class="p-3">
                            <a href="tel:+1<?php echo $value['tel'] ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                <i class="fas fa-mobile-alt text-muted mr-2"></i>+1 <?php echo $value['tel'] ?></a>
                            <a href="mailto:<?php echo $value['email'] ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
