                    ...
                    <div class="panel-container">
                        ...
                        <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="username" id="simpleinput" class="form-control" value="<?php echo $edit_user_arr['name']?>">
                            </div>

                            <!-- title -->
                            <div class="form-group">
                                <label class="form-label" for="simpleinput">Место работы</label>
                                <input type="text" name="position" id="simpleinput" class="form-control" value="<?php echo $edit_user_arr['position']?>">
                            </div>

                            <!-- tel -->
                            <div class="form-group">
                                <label class="form-label" for="simpleinput">Номер телефона</label>
                                <input type="text" name="tel" id="simpleinput" class="form-control" value="<?php echo $edit_user_arr['tel']?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="address" id="simpleinput" class="form-control"
                                       value="<?php echo $edit_user_arr['address']?>">
                            </div>
