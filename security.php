...
$edit_user_arr = get_user_by_email($user_edit_id);

$user_edit_email =get_email_by_id($user_edit_id);

$_SESSION['edit_id']= $user_edit_id ; // юзера id в сессию
$_SESSION['edit_email'] =$user_edit_email; // старый email
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email" id="simpleinput" class="form-control" value="<?php echo $user_edit_email; ?>">
                                </div>
